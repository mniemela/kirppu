...
(function() {
  ...
  this.ItemSearchForm = (function() {
    ...
    function ItemSearchForm(action) {
      ...
      this.typeInput = $('<select multiple class="form-control">').append((function() {
    ...
    ItemSearchForm.prototype.onSubmit = function(event) {
      ...
      return this.action(this.searchInput.val(), this.minPriceInput.val(), this.maxPriceInput.val(), this.typeInput.val());
    };
...
(function() {
  ...
  this.ItemFindMode = (function(superClass) {
    ...
    ItemFindMode.prototype.doSearch = function(query, min_price, max_price, type) {
