...
(function() {
  var C, PriceTagsConfig, addItem, bindFormEvents, bindItemToListEvents, bindItemToPrintEvents, bindItemToggleEvents, bindListTagEvents, bindNameEditEvents, bindPriceEditEvents, bindTagEvents, createTag, deleteAll, deleteIsDisabled, listViewIsOn, moveItemToList, moveToList, moveToPrint, onClickToList, onClickToPrint, onPriceChange, toggleDelete, toggleListView, unbindTagEvents;
  ...
  moveItemToList = function(tag, code) {
    unbindTagEvents($(tag));
