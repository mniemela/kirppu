...
(function() {
  var CheckoutMode, ClerkLoginMode, CounterMode, CounterValidationMode, ItemCheckInMode, ItemCheckoutMode, ItemFindMode, ModeSwitcher, b64_to_utf8, contentAfterPrefixRe, setClass, utf8_to_b64,
  ...
  ItemCheckoutMode = (function(_super) {
  ...
  ItemCheckInMode = (function(_super) {
    __extends(ItemCheckInMode, _super);

    ItemCheckInMode.registerEntryPoint("vendor_check_in", ItemCheckInMode);

    function ItemCheckInMode(config) {
      ItemCheckInMode.__super__.constructor.call(this, config);
    }
